...
function Family(props) {
    ...
    return (
        <AnimatePresence>
            ...
            >
                <Header className={styles.otherPage} showButtonContact={false} showSocial={false} navbarItems={navbarItems} />
                <Preview className={styles.preview} isIcon={false} title={(<>Семейная ипотека: <br /> Программа для <br /> семей с детьми</>)} textButton="Получить ипотеку" image="teddyBear" width="420px">
                ...
                <CardsList className={styles.cardsList} padding={"24px"} background items={advantsgeItems} icon={(
                    <svg style={{ minWidth: "24px", minHeight: "24px" }} width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M12.4193 15.802L8.72051 12.1031L6.87109 13.9525L12.4193 19.5008L21.6664 10.2537L19.817 8.4043L12.4193 15.802Z" fill="#00071F" />
                    </svg>
                )} />
                <Conditions
                    icon={<svg style={{ minWidth: "16px", minHeight: "24px" }} width="16" height="24" viewBox="0 0 16 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <line y1="10.5" x2="16" y2="10.5" stroke="#00071F" />
                    </svg>}
                    image="homeOnBackground" width='566px' className={styles.conditions}
                />
                <Conditions items={newItems} flexDirection={"row-reverse"} image="heart" width='566px' className={styles.conditions2}
                            icon={<svg style={{ minWidth: "22px", minHeight: "22px" }} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect width="24" height="24" rx="12" fill="url(#paint0_linear_873_3134)" />
                                <path d="M9.75 15.1641L17.6953 7.18359L18.75 8.23828L9.75 17.2383L5.56641 13.0547L6.58594 12L9.75 15.1641Z" fill="white" />
                                <defs>
                                    <linearGradient id="paint0_linear_873_3134" x1="1.21967" y1="22.6154" x2="23.6305" y2="22.0953" gradientUnits="userSpaceOnUse">
                ...
                <Breadcrumbs className={styles.breadcrumbs} items={breadcrumb}
                             icon={<svg className={styles.svg} style={{ minWidth: "18px", minHeight: "18px" }} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                 <path d="M7.75694 6.34292L9.17115 4.92871L16.2422 11.9998L9.17112 19.0708L7.75691 17.6566L13.4138 11.9998L7.75694 6.34292Z" fill="#666A79" />
                             </svg>}
                />
