...
const family = [
    ...
    { title: '15 млн', subtitle: 'Макс. сумма кредита' },
];
    ...
    const newItems = [
        {
            ...
            items: ['Семьи, в которых есть двое и более несовершеннолетних детей, или один ребёнок до 7 лет;', 'Семьи, в которых воспитывается ребёнок с инвалидностью;', 'Родители усыновлённых (удочерённых) детей могут принять участие в программе на тех же условиях, \n' + 'что и кровные родители.']
        },
    ];
